...
const AllRooms = () => {
    ...
    // Data for filters
    const roomTypes = ['Single Bed', 'Double Bed', 'Suite', 'Deluxe Room'];
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-6 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='bg-white w-full lg:w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16 rounded-xl overflow-hidden'>
          <div className={`flex items-center justify-between px-5 py-2.5 border-gray-300 ${openFilters ? "border-b" : "max-lg:border-b-0 lg:border-b"}`}>
